...
class DefaultDataset(DatasetTemplate):
    ...
    def __questions(self) -> list[DatasetEntry]:           
        ...
        defintions = [
            ...
            DatasetEntry(
                ...
                category=EntryCategory.DEFINITION,
                file_path = "lyrics/William-Wordsworth-I-Wandered-Lonely-as-a-Cloud.pdf"
                ),
            DatasetEntry(
        ...
        comparatives = [
            DatasetEntry(
                ...
                correct_answer="""In the Little Prince we observe how the feelings of both characters evolve as the story progresses.
                                ...
                                Rose's feelings:
                                The rose, while initially proud and somewhat distant, ultimately learns about vulnerability and the importance of love.
                                Her feelings evolve from a desire for admiration to an understanding of deeper emotional connection, especially when the Little Prince leaves and she regrets her pride.
                """,
                relevant_contexts= [
